...
start "" "javaw.exe" "-jar" "-splash:tikione-steam-cleaner.png" "-Xms32m" "-Xmx512m" "-XX:-HeapDumpOnOutOfMemoryError" "-XX:HeapDumpPath=crashdump.hprof" "tikione-steam-cleaner.jar" "enablePortablemode"
