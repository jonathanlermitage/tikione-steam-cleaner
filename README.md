...
:cat: **To fix font rendering on hdpi screens, please try JRE9 (Java 9 JVM), it seems to work.** See [v3.0.7-jre9 pre-release](https://github.com/jonathanlermitage/tikione-steam-cleaner/releases/tag/v3.0.7-jre9).
